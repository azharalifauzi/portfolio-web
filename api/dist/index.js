            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (process.env.NODE_ENV === 'development')
                        app.use(altair_express_middleware_1.altairExpress({ endpointURL: '/graphql/', baseURL: '/graphql/' }));
                    ...
                    // @ts-ignore
                    return [4 /*yield*/, new Promise(function (resolve) { return app.listen({ port: 5000 }, resolve); })];
                case 1:
                    // @ts-ignore
                    _a.sent();
